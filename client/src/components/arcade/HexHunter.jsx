...
const HexHunter = ({ dispatch }) => {
    ...
    return (
        <div className="w-full max-w-2xl mx-auto space-y-6 px-4 flex flex-col items-center animate-in fade-in duration-700">
            ...
            <div className="relative bg-slate-50 dark:bg-slate-950 p-6 rounded-[2rem] border border-border dark:border-white/5 shadow-xl dark:shadow-2xl transition-all duration-500 w-full flex flex-col items-center">
                {/* Target Color Blob */}
                <div className="relative group mb-8">
                    <div
                        className="w-40 h-40 mx-auto rounded-full shadow-2xl border-[6px] border-white dark:border-background transition-all duration-500 transform group-hover:scale-105"
                        style={{
